...
**Health Checker** is an AI-powered symptom analysis platform designed to help users understand possible medical conditions based on their reported symptoms. Leveraging large language models (LLMs) and optional integration with generative AI APIs (Google Gemini), the system interprets symptoms, assesses severity, and provides plausible conditions with reasoning.
...
- github : https://github.com/abinaya-emana


https://github.com/user-attachments/assets/7ba16817-e333-46a1-80ae-6e47d85d8349
